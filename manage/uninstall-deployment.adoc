...
** Per spostarli in un archivio dati non gestito, fare riferimento a https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/migrate-a-virtual-machine-with-storage-vmotion.html["Storage vMotion"^]
