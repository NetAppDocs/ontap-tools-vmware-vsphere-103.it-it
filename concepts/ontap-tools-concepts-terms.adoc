...
I nuovi sistemi NetApp ASA r2 offrono una soluzione hardware e software unificata che crea un'esperienza semplificata specifica per le esigenze dei clienti SAN-only. https://docs.netapp.com/us-en/asa-r2/get-started/learn-about.html["Informazioni sui sistemi di storage ASA R2"^].
...
Un gruppo di coerenza è una raccolta di volumi gestiti come un'unica unità. In ONTAP, i gruppi di coerenza offrono una gestione semplificata e una garanzia di protezione per un carico di lavoro applicativo distribuito su più volumi. Scopri di più https://docs.netapp.com/us-en/ontap/consistency-groups/index.html["gruppo di coerenza"^].
